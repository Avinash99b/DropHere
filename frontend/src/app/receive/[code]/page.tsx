...
export default function ReceivePage() {
  ...
  }, [data, isDownloadComplete, cleanupPeer, toast]);
      ...
      return (
        <div className="p-4 border rounded-lg bg-muted/50 text-center">
            ...
            <div className="mt-6 flex flex-col items-center">
                ...
                <p className="text-sm text-muted-foreground">The file has been saved to your downloads folder.</p>
            </div>
        </div>
      );
    }
             ...
             <div className="flex flex-col items-center justify-center space-y-4 p-8">
                ...
                <div className="w-full">
                    ...
                    <p className="text-sm text-center mt-2 text-muted-foreground">
                        { (receivedSize / 1024 / 1024).toFixed(2) } MB / { (fileMetadata.filesize / 1024 / 1024).toFixed(2) } MB
                    </p>
                </div>
            </div>
        )
